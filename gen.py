...
app = Client('::memory::', in_memory=True, api_hash='cc848d8cd67ff60f113ad08a6f0c253d', api_id=20796555, lang_code="ar", bot_token=w['8296981253:AAEl_UlZSW_6PRNqZxwdfrhjZRLvG-CgD_U'])
...
async def generate_session(app, message):
    ...
    msg = message
    api_id = 20796555
    api_hash = "cc848d8cd67ff60f113ad08a6f0c253d"
